## VSEMb: avoid high correlation between parameters 3 (LUE) and 4(GAMMA).
# 4 is fixed, parameter 7 is calibrated instead (parSel was modified).
...
save(save.list, file = "./out/reference_VSEMb_list.RData") 
