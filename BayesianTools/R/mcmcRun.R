...
#' @param settings for each sampler. If a setting is not provided, defaults will be used. To see the defaults, use the function \code{\link{applySettingsDefault}} as in applySettingsDefault(sampler = "SAMPLERNAME")
...
#' @param settings optional list with parameter that will be used instead of the defaults
