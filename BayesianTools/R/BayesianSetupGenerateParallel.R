...
#' @param parallel should a parallel R cluster be used? If set to T, machine will automatically detect the available cores and n-1 of the available n cores will be used. Alternatively, you can manually set the number of cores to be used
