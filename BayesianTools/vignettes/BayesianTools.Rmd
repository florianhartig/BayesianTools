...
Only for comparison, there are a number of other Metropolis-type algorithms implemented in the BT package. In principle, either of these algorithms can be emulated via the options of the main Metropolis functions. We do not recommend using these algorithms except for comparisons. 
...
This extension allows for the use of fewer chains and parallelization.
...
The second implementation uses the same extension as the DEzs sampler. Namely sampling from past states and a snooker update. Also here this extension allows for the use of fewer chains and parallelization.
