...
A BayesianSetup is created by the createBayesianSetup function. The function expects a log-likelihood and log-prior. It calculate automatically the posterior and various convenience functions for the samplers. 
...
If you want to create your own BayesianSetup, note the following:

### Likelihood definition

The likelihood function needs to be provided as the log likelihood density of a parameter vector 
...
The following information can be provided to createPrior:
...
As an example, the choosing the sampler name "Metropolis" calls a versatile Metropolis-type MCMC with options for covariance adaptation, delayed rejection, tempering and Metropolis-within-Gibbs sampling is available via the Metropolis option. For details, see the help. This is how we would call the base version of this sampler
...
The T-walk is another MCMC algorithm. 
