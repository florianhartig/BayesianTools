...
\paragraph{Case 1 - model programmed in R} Usually, you will have to do nothing. Just make sure you can call your model like that
...
\paragraph{Case 3 - compiled model, parameters set via command line} Usually, you will have to do nothing. Just make sure you can call your model like that
...
\paragraph{Case 4 - compiled dll, parameters are set via dll interface } 

If you have your model prepared as a dll, or you can prepare it that way, you can use the \ref{https://stat.ethz.ch/R-manual/R-devel/library/base/html/dynload.html}{dyn.load()} function to link to your model
...
\paragraph{Case 5 - compiled model, parameters set via parameter file or in any other method} 
...
\paragraph{Case 6 - compiled model, parameters cannot be changed}
