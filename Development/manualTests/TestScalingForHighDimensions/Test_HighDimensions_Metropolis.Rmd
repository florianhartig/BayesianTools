---
title: "Test of scaling and mixing in high dimensions for MH"
author: "Stefan Paul"
date: "3. Juni 2016"
output: html_document
---

This document contains a test example for the Metropolis based sampler.
...
settings <- list(iterations = 100000, adapt = F, optimize = F)
...
plot(parVec, acc.rate, type = "b", main = "Acceptance rate for different dimensions",
...
Now the same tests are used for the adaptive MH.

```{r}
library(BayesianTools)
parVec <- c(3,5,10,20,50,100,200)

settings <- list(iterations = 100000, adapt = TRUE, optimize = FALSE)
